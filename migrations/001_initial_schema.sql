...
CREATE TABLE supervisor_attendance (
    ...
    INDEX idx_sa_date (attendance_date)
) ENGINE=InnoDB;
...
CREATE TABLE tasks (
    ...
    INDEX idx_task_vertical (vertical),
...
CREATE TABLE issues (
    ...
    INDEX idx_issue_parent (parent_type, parent_id),
...
CREATE TABLE uploads (
    ...
    FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE RESTRICT,
    FOREIGN KEY (deleted_by) REFERENCES users(id) ON DELETE SET NULL,
    INDEX idx_upload_parent (parent_type, parent_id),
    INDEX idx_upload_visibility (authority_visibility),
...
CREATE TABLE worker_attendance (
    ...
    INDEX idx_wa_date (attendance_date)
) ENGINE=InnoDB;
...
CREATE TABLE worker_daily_entries (
    ...
    FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE RESTRICT,
    FOREIGN KEY (override_by) REFERENCES users(id) ON DELETE SET NULL,
    INDEX idx_wde_worker_date (worker_id, entry_date),
    INDEX idx_wde_task (task_id),
    INDEX idx_wde_date (entry_date)
) ENGINE=InnoDB;
